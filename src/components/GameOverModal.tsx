...
export function GameOverModal({ winner, onNewGame }: GameOverModalProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
      <div className={cn(
        ...
        <Button 
          onClick={onNewGame}
          className="px-8 py-6 text-lg font-semibold bg-primary hover:bg-primary/90 text-primary-foreground glow-gold"
        >
          Play Again
        </Button>
      </div>
